...
<template>
  <div
    class="col-span-12 rounded-sm border border-stroke bg-white p-7.5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-8"
  >
    <div class="mb-4 justify-between gap-4 sm:flex">
      <div>
        <h4 class="text-xl font-bold text-black dark:text-white">Attendance Overview</h4>
